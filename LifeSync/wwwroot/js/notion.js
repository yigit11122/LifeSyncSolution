// wwwroot/js/notion.js
const NOTION_CLIENT_ID = '1b9d872b-594c-807f-bf84-0037fed59b9c'; // Notion Client ID
...
async function fetchNotionPages() {
    ...
    try {
        ...
        if (!response.ok) throw new Error(`Notion veri çekme başarısız: ${response.status}`);
